...
export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    if (!args[0]) return m.reply('《✧》 Por favor, ingrese un enlace de Instagram.')
    ...
    try {
      ...
      // Variables para el caption
      const title = data.title || 'Desconocido'
      const description = data.caption || 'Sin descripción'
